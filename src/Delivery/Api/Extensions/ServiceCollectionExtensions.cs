...
namespace devboost.dronedelivery.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private const string MONGODB_SETTINGS = "MongoDbSettings";
        ...
        {
            var mongoDbSettings = configuration.GetSection(MONGODB_SETTINGS).Get<MongoDbSettings>();
            ...
            services.AddScoped<IPedidoMongoRepository, PedidoRepository>();

            //services.AddScoped(new RepositoryBaseMongoDb<Pedido>(services.BuildServiceProvider().GetRequiredService<IOptions<MongoDbSettings>>().Value));
        ...
        public static void AddAuthServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options =>
                options.UseInMemoryDatabase("UseInMemorySql"));
